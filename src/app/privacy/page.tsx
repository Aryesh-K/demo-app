    ...
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="flex flex-col gap-10 leading-relaxed text-slate-300">
        ...
        <Section title="1. Introduction">
          <p>
            ToxiClear AI (&ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;) is committed to
            protecting your privacy. This Privacy Policy explains what information we collect, how we
            use it, and your rights regarding your data. By creating an account or using ToxiClear AI,
        ...
        <Section title="4. Data Storage and Security">
          <p>
            Your account data is stored securely using Supabase, a trusted database platform with
            industry-standard encryption. Health profile information is encrypted at rest. We use
            HTTPS for all data transmission. While we take security seriously, no system is 100%
            secure — please use a strong, unique password.
          </p>
        </Section>

        <Section title="5. Third-Party Services">
          <p>ToxiClear AI uses the following third-party services to operate:</p>
          <BulletList items={[
        ...
        <Section title="6. Health Information Disclaimer">
          <p>
            ToxiClear AI is an educational tool, not a medical service. Any health information you
            provide in your profile is used solely to personalize educational content. It is not
            reviewed by medical professionals, not stored in any medical record system, and not
            subject to HIPAA. Do not rely on ToxiClear AI for medical decisions. Always consult a
        ...
        <Section title="8. Children's Privacy">
          <p>
            ToxiClear AI is not intended for children under 13. We do not knowingly collect personal
